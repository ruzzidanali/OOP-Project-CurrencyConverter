...
public class AboutWindow extends JFrame {
	...
	// label with a clickable link
        JLabel lblLink = new JLabel("http://www.group8.com");
	...
	lblLink.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("http://www.group8.com"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
	...
	lblTitle.setFont(new Font("CSF3109", Font.BOLD, 15));
        contentPane.add(lblTitle);

	// label "licence"
        JLabel lblLicenceMit = new JLabel("CSF3109");
	...
	contentPane.add(lblLicenceMit);
        ...
        // label "version"
        JLabel lblVersion = new JLabel("OOP");
